...
################################################################################
filename <- "E:/vitek_sdgmm_preprint/pseudomonas/imzml/PA14_TLCA_2 DAYS_2016-06-09.imzML"
unprocessed <- readMSIData(filename)
spots <- "E:/vitek_sdgmm_preprint/pseudomonas/imzml/PA14_TLCA_2 DAYS_2016-06-09.txt"
rois <- list(c('No_TLCA_Control', 'control'),
             c('250uM_TLCA_Control', 'tlca'),
             c('PA14', 'pseudomonas'),
             c('PA14_250uM_TLCA', 'pseudomonas_tlca'))
...
################################################################################
pseudo1 <- list('unprocessed'=unprocessed, 'processed'=processed, 'ssc'=ssc,
