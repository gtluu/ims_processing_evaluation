...
################################################################################
unprocessed <- as(readMSIData("PA14_TLCA_2 DAYS_2016-06-09.imzML",
...
################################################################################
pseudo1 <- list('processed'=processed, 'ssc'=ssc, 'sscParams'=sscParams)

save.image("pseudomonas_2016-06-09.RData")
