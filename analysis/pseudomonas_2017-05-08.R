...
################################################################################
unprocessed <- as(readMSIData("PA14_TLCA_201-05-08.imzML",
...
################################################################################
pseudo4 <- list('processed'=processed, 'ssc'=ssc, 'sscParams'=sscParams)

save.image("pseudomonas_2017-05-08.RData")
