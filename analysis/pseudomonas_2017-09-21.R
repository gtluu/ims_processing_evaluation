...
################################################################################
unprocessed <- as(readMSIData("PA14_TLCA_2017-09-21.imzML",
...
################################################################################
pseudo5 <- list('processed'=processed, 'ssc'=ssc, 'sscParams'=sscParams)

save.image("pseudomonas_2017-09-21.RData")
